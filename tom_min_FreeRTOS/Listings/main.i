...
#line 14 "main\\main.c"
#line 1 ".\\User\\include\\use_config.h"
...
int GetKey (void)  {
  ...
  return ((int)(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR & 0x1FF));
} 
...
void Beep_Init(void)
{
	...
	GPIO_Init88.GPIO_Pin=((uint16_t)0x0040);
	
	GPIO_Init88.GPIO_Mode=GPIO_Mode_Out_PP;
	GPIO_Init88.GPIO_Speed=GPIO_Speed_50MHz;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),&GPIO_Init88);
}
...
void Led_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000008)|((uint32_t)0x00000020), ENABLE);
	
	GPIO_Init88.GPIO_Pin=((uint16_t)0x0020);
	GPIO_Init88.GPIO_Mode=GPIO_Mode_Out_PP;
	GPIO_Init88.GPIO_Speed=GPIO_Speed_50MHz;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),&GPIO_Init88);
	
	GPIO_Init88.GPIO_Pin=((uint16_t)0x1000);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),&GPIO_Init88);
	
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0020));
	GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),((uint16_t)0x1000));
}
...
void Key_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000010)|((uint32_t)0x00000020)|((uint32_t)0x00000004), ENABLE);
	
	GPIO_Init88.GPIO_Pin=((uint16_t)0x2000);
	GPIO_Init88.GPIO_Mode=GPIO_Mode_IPU;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000)),&GPIO_Init88);
	
	GPIO_Init88.GPIO_Pin=((uint16_t)0x0008);
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1400)),&GPIO_Init88);
	
	GPIO_Init88.GPIO_Pin=((uint16_t)0x0001);
	GPIO_Init88.GPIO_Mode=GPIO_Mode_IPD;
	GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),&GPIO_Init88);
}
...
void data_write(void)
{
		...
		res = f_open(&fsrc, "tom_min.txt", 0x10 | 0x01 | 0x02);
		if(res == FR_OK)
		{
				tom_size = fsrc.fsize;
...
{  
		...
		tmp = xTaskCreate(Data_sema1, "Data_pack", 500, 0 ,1, &data_pack_task);
		if(tmp != ( ( ( BaseType_t ) 1 ) ))
		{
		...
		tmp = xTaskCreate(Data_sema2, "Data_transfer", 500, 0 ,2, &data_transfer_task);
		if(tmp != ( ( ( BaseType_t ) 1 ) ))
		{
		...
		tmp = xTaskCreate(Data_sema3, "Data_sema", 500, 0 ,3, &data_sema);
		if(tmp != ( ( ( BaseType_t ) 1 ) ))
		{
...
{   
		...
		RCC_APB2PeriphClockCmd(((uint32_t)0x00000004)|((uint32_t)0x00000001)|((uint32_t)0x00004000), ENABLE);
		GPIO_Configure();
		USART_Configure();


		printf("welcome to APPLICATION, VERSION is %s.\r\n","STM32F103VET6_APPLICATION_V_11_20191007");
